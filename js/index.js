...
coolform
  .directive('coolForm', function($timeout) {
    var ctrl = function($scope, $element, $attributes) {
      ...
      $scope.questions.push({'question': 'What are your requirements ?'});
      $scope.questions.push({'question': 'What is the expected count ?'});
      $scope.questions.push({'question': 'Enter the representative name ?'});
      $scope.questions.push({'question': 'Enter the representative contact ?'});
      function removeOpen() {
